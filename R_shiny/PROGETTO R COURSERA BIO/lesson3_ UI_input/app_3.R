...
library(shiny)
gn <- read.csv(
    paste(getwd(),'/inc/genes_names.csv', sep = ''))
# ==================================================== global.R END =============
...
ui <- fluidPage(
    ...
    # Sidebar 
    sidebarLayout(
        #divide le schermata in due, una è il siderpanel dove vediamo i vari widget visivi che scegliamo di mettere 
        sidebarPanel(
...
# l'altra parte è riservata all'output che vogliamo ci visualizzi 
